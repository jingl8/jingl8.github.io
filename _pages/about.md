...
I am PhD candidate (ABD) in political science at UIUC, my research interests are in statistical and computational methods, and substantively in American and comparative politics. I have done research projects on a dynamic model of polarization under segregation, boostrap standard errors for matching estimators, model evaluation metrics for binary classification tasks, the contextual and temporal variation of individuals' attitudes towards globalization, A Lasso-agumented alternative to synthetic control method: estimating the effect of Hong Kong's sovereignty return to China, meta-analysis as a multiple hypothesis testing problem, etc.  Please feel free to reach out.
